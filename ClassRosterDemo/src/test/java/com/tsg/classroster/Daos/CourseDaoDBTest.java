...
class CourseDaoDBTest {
    ...
    public void testGetAllCourses() {
        ...
        course.setTeacher(teacher);
        course.setStudents(students);
        course.setDescription("Test Course Description1");
        course = courseDao.addCourse(course);
        ...
        course2.setDescription("Test Course Description2");
    ...
    public void testDeleteCourseById() {
        ...
        course.setTeacher(teacher);
        course.setStudents(students);
        course.setDescription("Course Description1");
        course = courseDao.addCourse(course);
    ...
    public void testGetCoursesForTeacher() {
        ...
        course3.setDescription("Course Description 3");
    ...
    public void testGetCoursesForStudent() {
        ...
        course2.setDescription("Course Description2");
        course2 = courseDao.addCourse(course2);
        ...
        course3.setTeacher(teacher);
        course3.setStudents(students);
        course3.setDescription(("Course Description3"));
        course3 = courseDao.addCourse(course3);
